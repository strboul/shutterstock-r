...
greater than the capabilities of the basic authentication. Read [this vignette](https://cran.r-project.org/web/packages/shutterstock/vignettes/oauth-authentication.html) for
